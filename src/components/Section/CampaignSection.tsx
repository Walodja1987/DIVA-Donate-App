...
export const CampaignSection = () => {
	...
	useEffect(() => {
		...
		getDecimals()
		if (chainId === '0x89' && activeAddress != null && wagmiProvider != null) {
	...
	}, [chainId, decimals, activeAddress, usdtTokenContract, wagmiProvider])
						...
						<div className="p-5">
							...
							<div className="mb-5 border-b-2 border-[#9FC131]">
								<p className="mb-3 font-normal text-[#000000]">
									A conditional donation campaign to provide insurance to 100
									pastoralists in Kenya to financially assist them in case of
									drought.
								</p>
							</div>
