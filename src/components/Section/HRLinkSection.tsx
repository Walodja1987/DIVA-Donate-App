...
export const HRLinkSection = () => (
  <div className="container justify-center mx-auto">
    ...
    <div>
        <a
          href="https://www.forbes.com/sites/anafaguy/2023/06/18/vaccine-scientist-peter-hotez-says-he-was-stalked-after-billionaires-and-joe-rogan-urge-him-to-debate-rfk-jr/?sh=645073e63624"
      ...
      <div>
        <a
          href="https://twitter.com/joerogan/status/1670196590928068609?s=20"
          className="group block max-w-2xl mx-auto rounded-lg p-6 bg-white space-y-3"
          target={'_blank'} rel="noreferrer"
        >
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-[#005C53] font-['lora'] text-2xl font-semibold">
              Joe Rogan debate invite
            </h3>
          </div>
          <p className="text-[#042940] font-semibold text-base">
            Joe Rogan publicly invited Hotez to a debate with RFK regarding covid vaccines
          </p>
        </a>
      </div>
      ...
      <div>
        <a
          href="https://twitter.com/joerogan/status/1670217682640072704?s=20"
          className="group block max-w-2xl mx-auto rounded-lg p-6 bg-white space-y-3 "
          target={'_blank'} rel="noreferrer"
        >
          <div className="flex items-center space-x-3">
