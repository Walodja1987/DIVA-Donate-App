...
const DONATION_SPECIFICATIONS: DonationDetail[] = [
	{
		...
		description: '1 + NDVI eVIIRS (May 2024)',
		image: '/Images/rain.png',
	},
	{
		title: 'Expiry',
		description: '10 June 2024, 7:00pm UTC',
		image: '/Images/Expiry.png',
	},
	{
		title: 'Reporter',
		description: 'Tellor Protocol',
		image: '/Images/Reporter.png',
	},
	{
		title: 'Data source',
		description: 'NDVI eVIIRS',
		link: 'https://earlywarning.usgs.gov/fews/ewx/index.html',
...
export const DonationSection3: React.FC = () => {
	return (
				...
				<div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between lg:px-4 py-8 gap-8 lg:gap-40 lg:py-16">
					...
					<div className="lg:mt-0 lg:flex w-full lg:w-[450px] mt-10">
						<Image
							...
							width="800"
							height="800"
							src="/Images/payoff_profile_pastoralists_mar_may_2024.png"
