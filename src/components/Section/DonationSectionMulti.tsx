...
// @todo Largely duplicate of DonationSection.tsx. Clean up
type DonationDetail = {
	title: string
	description: string
	link?: string
...
const DONATION_SPECIFICATIONS: DonationDetail[] = [
	{
		...
		description: '1 + Average NDVI (1 Oct - 22 October 2023)',
		image: '/Images/rain.png',
	},
	{
		title: 'Expiry',
		description: '2 January 2024, 11am UTC',
		image: '/Images/Expiry.png',
	},
	{
		title: 'Reporter',
		description: 'Shamba Network',
		link: 'https://polygonscan.com/address/0xbf405c325841545033920F59E9Aa9fe3d9c3c517',
		image: '/Images/Reporter.png',
	},
	{
		title: 'Data source',
		description: 'eVIIRS satellite data',
		image: '/Images/Data.png',
	},
]

// Greenish component on the left including the conditional donation specifications
	...
	<div className="rounded-xl">
		<div className="lg:pr-[10rem] w-full overflow-visible relative mx-auto shadow-lg ring-1 ring-black/5 rounded-xl flex items-center lg:gap-6 bg-[#DEEFE7]">
			...
			<div className="flex flex-col justify-center lg:text-4xl text-left py-2 pl-16 lg:pl-24 min-h-[80px] pr-3">
				...
				{link ? ( // Check if a link is provided
...
export const DonationSectionMulti: React.FC = () => {
	return (
		<div className="flex justify-center w-full">
			<div className="mx-auto lg:mx-0 px-6 lg:px-0 lg:max-w-screen-2xl">
				...
				<div className="flex flex-col lg:flex-row items-center justify-center lg:px-4 py-8 gap-8 lg:gap-40 lg:py-16 lg:flex-wrap">										
					<div className="lg:mt-0 lg:flex w-full lg:w-[550px] mt-10">
						<Image
							className="w-full"
							width="800"
							height="800"
							src="/Images/payoff_profile_kajiado.png"
							alt="Donation profile Kajiado"
						/>						
					</div>
					<div className="lg:mt-0 lg:flex w-full lg:w-[550px] mt-10">
						<Image
							...
							width="800"
							height="800"
							src="/Images/payoff_profile_laikipia.png"
							alt="Donation profile Laikipia"
						/>					
					</div>
