...
export default function Donations() {
  ...
  useEffect(() => {
    setChainId((window as any as any).ethereum.chainId);
  ...
  }, [chainId, decimals, balance, activeAddress, usdtTokenContract]);
  useEffect(() => {
    const percentage = ((Number(donated) / balance) * 100).toFixed(2);
            ...
            <div className="p-5">
              ...
              <div className="mb-5 border-b-2 border-[#9FC131]">
                <p className="mb-3 font-normal text-[#000000]">
                  ...
                  to 100 pastoralists in Kenya to financially assist them in
                  case of drought.
                </p>
              </div>
