...
export const LinkSectionPastoralists6 = () => (
	<div className="container justify-center mx-auto mt-10">
		...
		<div className="grid grid-rows-2 gap-6 pb-16 lg:grid-cols-2">
			<div>
				<a
					href="https://www.divadonate.xyz/posts/diva-conditional-donations-pastoralists-5"
					...
					<p className="text-[#042940] font-semibold text-base">
						Empowering pastoralists in Kenya - The 6th DIVA Donate campaign
					</p>
				</a>
			</div>
