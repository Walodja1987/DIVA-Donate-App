// @todo Merge with LinkSection component

export const LinkSectionPastoralists2 = () => (
	<div className="container justify-center mx-auto mt-10">
		...
		<div className="grid grid-rows-2 gap-6 pb-16 lg:grid-cols-2">
			...
			<div>
				<a
					href="https://www.divaprotocol.io/posts/diva-conditional-donations-mcv-pilot"
					className="group block max-w-2xl mx-auto rounded-lg p-6 bg-white space-y-3"
					target={'_blank'}
					rel="noreferrer">
					<div className="flex items-center space-x-3">
					...
					<p className="text-[#042940] font-semibold text-base">
						Event-driven conditional donations - A pilot program by DIVA
						Technologies AG, Fortune Connect and Shamba Network
					</p>
				</a>
			</div>
