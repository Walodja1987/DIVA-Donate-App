...
export const FooterSection = () => (
	<footer className="bg-[#042940] flex justify-center">
		<div className="lg:max-w-screen-2xl w-full p-4 md:p-6">
			<div className="md:flex justify-between">
				...
				<div>
					<ul className=" text-[#DEEFE7] md:self-center py-6 space-y-4 md:text-center sm:flex sm:space-y-0 sm:justify-around sm:space-x-4 lg:flex-1 lg:justify-start">
						<li className="mb-4">
