...
<table style={{ borderCollapse: 'collapse', width: '100%' }}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>20 Oct 2025</td>
      <td>0.50</td>
      <td><strong style={{ color: 'green' }}>Payout</strong></td>
    </tr>
    <tr>
      <td>3</td>
      <td>31 Oct 2025</td>
...
<div style={{ fontSize: '0.92em', fontStyle: 'italic', marginTop: '0.3em', marginBottom: '1.7em' }}>
...
1. **RLUSD deposits:** Donors deposit RLUSD into the DIVA Protocol escrow contract, where funds are held securely until the outcome is determined.
2. **Oracle reports outcome:** The Oracle observes the campaign (NDVI measurements) and reports the outcome to the DIVA Protocol once the reporting window opens.
3. **DIVA Protocol determines payout:** Based on the reported outcome, the blockchain protocol automatically determines whether funds should be released. If the NDVI threshold is breached, funds are made available for the custodian (Fortune Credit) to claim; otherwise, unreleased funds can be claimed back by the Donor.
4. **Custodian claims and off-ramps:** The custodian claims any released RLUSD funds and converts them from digital assets to traditional currency through an off-ramp process.
5. **Distribution via M-Pesa:** The custodian distributes the converted funds to pastoralists via M-Pesa, Kenya's mobile money platform.
6. **Pastoralists withdraw:** Beneficiaries receive funds in their M-Pesa accounts and can withdraw them as needed.
...
<div className="text-black opacity-80 font-serif" style={{ display: 'inline' }}><a href="/final-results-dashboard2.html" target="_blank" rel="noopener noreferrer">Open the results dashboard</a> for full tables, charts, and methodology notes.</div>
