...
Total costs represented **3.6%** of the gross payout value, exceeding the **2.5%** recorded in the initial MCV pilot campaign (Q4 2023), which utilized a single end-of-season reporting model. This increase is consistent with our expectation that a multi-window payout structure would lead to higher overall transaction costs. Despite this increase, the 3.6% cost remains approximately **65% lower** compared to the 10–35% in fees and operational costs typically associated with traditional transfer methods.
...
3. **Building beneficiary trust through smaller and more frequent payouts**
...
6. **Transaction failures in M-Pesa disbursement**
   In total, 116 transfers failed during the M-Pesa transfers due to [**REASON_PLACEHOLDER + How to improve -> Benson**].
